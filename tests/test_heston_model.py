...
class TestHestonModel(unittest.TestCase):
    ...
    def test_heston_call_example_1(self):
        ...
        theta = 0.04 # Variance moyenne à long terme (volatility^2 = 0.04 -> vol = 0.20)
        ...
        calculated_price = heston_price(S, K, T, r, kappa, theta, sigma, rho, v0, option_type)
        ...
        print(f"Test Heston Call 1: Calculé={calculated_price:.3f}, Attendu={expected_price:.3f}")
    ...
    def test_heston_put_example_1(self):
        ...
        self.assertAlmostEqual(calculated_price, expected_price, places=2)
        print(f"Test Heston Put 1: Calculé={calculated_price:.3f}, Attendu={expected_price:.3f}")
