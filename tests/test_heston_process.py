...
class TestHestonProcess(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.N_simulations = 10000 # Nombre de simulations pour des résultats statistiques fiables
    ...
    def test_variance_positivity(self):
        ...
        self.assertTrue(np.all(paths_V >= 0.0), "La variance doit toujours être non-négative.")
