...
class TestBjerksundStenslandModel(unittest.TestCase):
    ...
    def test_call_option_no_dividends(self):
        ...
        print(f"Test Call sans dividendes: Calculé={calculated_price:.3f}, Attendu={expected_price:.3f}")
    ...
    def test_put_option_no_dividends(self):
        ...
        calculated_price = bjerksund_stensland_2002(option_type, S, K, T, r, sigma, q)
        self.assertAlmostEqual(calculated_price, expected_price, places=3)
        print(f"Test Put sans dividendes: Calculé={calculated_price:.3f}, Attendu={expected_price:.3f}")
    ...
    def test_call_option_with_dividends(self):
        ...
        calculated_price = bjerksund_stensland_2002(option_type, S, K, T, r, sigma, q)
        self.assertAlmostEqual(calculated_price, expected_price, places=3)
        print(f"Test Call avec dividendes: Calculé={calculated_price:.3f}, Attendu={expected_price:.3f}")
    ...
    def test_put_option_with_dividends(self):
        ...
        calculated_price = bjerksund_stensland_2002(option_type, S, K, T, r, sigma, q)
        self.assertAlmostEqual(calculated_price, expected_price, places=3)
        print(f"Test Put avec dividendes: Calculé={calculated_price:.3f}, Attendu={expected_price:.3f}")
    ...
    def test_call_option_different_params(self):
        ...
        calculated_price = bjerksund_stensland_2002(option_type, S, K, T, r, sigma, q)
        self.assertAlmostEqual(calculated_price, expected_price, places=3)
        print(f"Test Call (autres params): Calculé={calculated_price:.3f}, Attendu={expected_price:.3f}")
    ...
    def test_put_option_different_params(self):
        ...
        calculated_price = bjerksund_stensland_2002(option_type, S, K, T, r, sigma, q)
        self.assertAlmostEqual(calculated_price, expected_price, places=3)
        print(f"Test Put (autres params): Calculé={calculated_price:.3f}, Attendu={expected_price:.3f}")
